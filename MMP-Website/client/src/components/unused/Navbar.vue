    ...
    >
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center">
                <img src="https://i.imgur.com/r1n1kss.png" class="h-8 mr-3" alt="MMP Logo" />
                <span
                    class="hidden self-center text-2xl text-logo-text font-semibold whitespace-nowrap dark:text-white md:block"
                    >Mission Ministries Philippines</span
                >
                <span
                    class="block self-center text-2xl font-semibold whitespace-nowrap dark:text-white md:hidden"
                    >MMP</span
                >
            </a>
            <div class="flex md:order-2">
                <button
                    type="button"
                    class="text-white bg-btn-1 hover:bg-btn-hover focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                    Apply Now
                </button>
                <button
